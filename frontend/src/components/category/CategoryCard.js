  ...
  return (
    <>
      <a
        ...
        className={`p-2 flex items-center rounded-md hover:bg-gray-50 w-full hover:text-store-600`}
        role="button"
      >
        {icon ? (
          <Image src={icon} width={24} height={24} alt="Category" />
        ) : (
          <Image
            ...
            <li key={children._id}>
              {children.children.length > 0 ? (
                <a
                  ...
                  className={`flex items-center font-serif pr-2 text-sm text-gray-600 hover:text-store-600 py-1 cursor-pointer`}
                >
