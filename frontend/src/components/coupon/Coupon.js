                ...
                <div className="flex items-center font-serif">
                  ...
                  <div className="ml-2">
                    {dayjs().isAfter(dayjs(coupon.endTime)) ? (
                      ...
                      <span className={`text-store-600 inline-block px-4 py-1 rounded-full font-medium text-xs bg-store-100`}>
                        Active
                      </span>
                    )}
                  </div>
            ...
            <div className="md:border-l-2 lg:border-l-2 border-dashed lg:w-1/3 md:w-1/3 relative px-4">
              <div className="info flex items-center">
                <div className="w-full">
                  <div className="block">
                    <div className={`font-serif border border-dashed bg-store-50 py-1 border-store-300 rounded-lg text-center block`}>
                      <CopyToClipboard
                      ...
                      >
                        <button className="block w-full">
                          {copied && coupon.couponCode === copiedCode ? (
                            <span className={`text-store-600 text-sm leading-7 font-semibold`}>
                              Copied!
                            </span>
                          ) : (
                            <span className={`uppercase font-serif font-semibold text-sm leading-7 text-store-600`}>
                              {coupon.couponCode}{" "}
                            </span>
                          )}
                        </button>
              ...
              <div className="info flex lg:my-6 md:my-5 mb-6 items-center">
                <div className="w-full">
                  <div className="block">
                    <div className="font-serif font-medium flex items-center mb-1">
                      ...
                      <div className="ml-2">
                        {dayjs().isAfter(dayjs(coupon.endTime)) ? (
                          ...
                          <span className={`text-store-600 inline-block`}>
                            Active
                          </span>
                        )}
                      </div>
                    ...
                    <div className={`font-serif border border-dashed bg-store-50 py-2 border-store-300 rounded-lg text-center block`}>
                      <CopyToClipboard
                        text={coupon.couponCode}
                        onCopy={() => handleCopied(coupon.couponCode)}
                      >
                        <button className="block w-full">
                          {copied && coupon.couponCode === copiedCode ? (
                            <span className={`text-store-600 text-base leading-7 font-semibold`}>
                              Copied!
                            </span>
                          ) : (
                            <span className={`uppercase font-serif font-semibold text-base leading-7 text-store-600`}>
                              {coupon.couponCode}{" "}
                            </span>
                          )}
                        </button>
