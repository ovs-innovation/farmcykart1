      ...
      <AnimatedContent>
        <div className="flex items-center pb-4">
          <ol className="flex items-center w-full overflow-hidden font-serif">
            <li className="text-sm pr-1 transition duration-200 ease-in cursor-pointer hover:text-store-500 font-semibold">
            ...
            {selectedObj?.map((child, i) => (
              <span key={i + 1} className="flex items-center font-serif">
                ...
                <li className="text-sm pl-1 transition duration-200 ease-in cursor-pointer text-blue-700 hover:text-store-500 font-semibold ">
